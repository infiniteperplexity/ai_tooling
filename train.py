...
# compares the loglikehood of choices, e.g. for HellaSwag
import torch.nn.functional as F
def define_multiple_choice_loglikelihood_accuracy(pad_token_id, input_key="choice_ids", target_key = "labels"):
    def _f(outputs, batch):
